...
from DQMOffline.Trigger.HLTElectronOfflineAnalyzer_cff import *

from DQMOffline.Trigger.EgHLTOfflineSource_cfi import *

# Muon: HLTMuonOfflineAnalyzer_cff inside
...
offlineHLTSource = cms.Sequence(
    hltResults *
    egHLTOffDQMSource *
    hltElectronOfflineAnalyzers * # python/HLTElectronOfflineAnalyzer_cff.py
    muonFullOfflineDQM *
    HLTTauDQMOffline *
